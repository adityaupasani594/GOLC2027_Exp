      ...
      >
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="text-center py-2">
            ...
            <p className="text-sm font-semibold text-indigo-700 mt-0.5">Construction and Analysis of an Inverted Index</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-400 text-center">
              {pct >= 70 ? '✓ Demonstrated understanding of Inverted Index construction and Boolean retrieval.' : 'Review theory to reinforce IR indexing and query processing concepts.'}
            </p>
          </div>
