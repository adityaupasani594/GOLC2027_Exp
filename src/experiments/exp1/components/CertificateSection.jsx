        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="text-center py-2">
            ...
            <p className="text-sm font-semibold text-indigo-700 mt-0.5">
              Multimodal Tokenization for Text, Visual Patches, Audio Frames &amp; Video Keyframes
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-400 text-center">
              {pct >= 70
                ? '✓ Demonstrated proficiency in multimodal tokenization for text, visual patches, audio frames, and video keyframes.'
                : 'Review theory and simulation lab to reinforce multimodal tokenization concepts.'}
            </p>
          </div>
