...
import { QUIZ_QUESTIONS, EXPERIMENT_CONFIG } from '../graphQueryEngine';
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-slate-500">
              Experiment 12 · Query Knowledge Graphs with Pattern-Based Queries ({questions.length} Questions)
            </p>
          </div>
        </div>
        ...
        {submitted && (
          ...
          >
            <div className="font-bold flex items-center gap-1.5 text-indigo-900">
              ...
              Graph Theory &amp; Pattern Query Explanation:
            </div>
