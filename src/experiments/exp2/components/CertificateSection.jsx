      ...
      >
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 px-8 py-8 text-white relative overflow-hidden">
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <p className="text-indigo-200 text-xs leading-relaxed">{EXP_INFO.subtitle}</p>
            </div>
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="text-center py-2">
            ...
            <p className="text-sm text-slate-500 mt-2">has successfully performed and recorded experimental trials for the simulation on</p>
            <p className="text-sm font-semibold text-indigo-700 mt-0.5">
              Text Preprocessing, Stop-Word Filtering, Heuristic Stemming &amp; Morphological Lemmatization
            </p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-400 text-center">
              {pct >= 70
                ? 'Demonstrated competency in text normalization pipelines, stop-word reduction, and morphological normalization.'
                : 'Review theory and simulation workbench to reinforce morphological normalization concepts.'}
            </p>
          </div>
          ...
          <div className="flex items-end justify-between pt-2">
            ...
            <div className="text-right">
              <div className="h-10 border-b-2 border-slate-300 w-36" />
              <p className="text-[10px] text-slate-400 mt-1">Lab Instructor Signature</p>
            </div>
          </div>
        </div>
      </motion.div>
