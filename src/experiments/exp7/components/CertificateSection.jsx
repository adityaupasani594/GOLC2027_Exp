        ...
        <div className="text-center space-y-6 max-w-2xl mx-auto relative z-10">
          ...
          <div className="space-y-1">
            ...
            <p className="text-[11px] text-slate-500 font-mono">
              Knowledge Graph &amp; Information Retrieval Systems (KGIRS)
            </p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs font-mono text-slate-500 pt-1">
              Roll / ID: {studentInfo.studentId || '2026-CS-000'}
            </p>
          </div>
          ...
          <div className="space-y-2 text-xs sm:text-sm text-slate-700 leading-relaxed px-4">
            <p>
              has successfully completed all laboratory components, dependency parsing simulations, knowledge graph extractions, and conceptual assessments for
            </p>
            <p className="font-bold text-base sm:text-lg text-indigo-900 font-serif">
              "{EXP_META.title}"
            </p>
            <p className="text-xs text-slate-500">
              demonstrating comprehensive competence in Named Entity Recognition (NER), passive voice syntactic inversion, semantic triple construction (S, R, O), and Knowledge Graph visual synthesis.
            </p>
          </div>
          ...
          <div className="grid grid-cols-3 items-end pt-8 border-t border-slate-100">
            <div className="text-center">
              ...
              <p className="text-[10px] font-bold text-slate-700 uppercase">Student</p>
              <p className="text-[9px] text-slate-400 font-mono">{today}</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-[9px] font-black uppercase tracking-wider text-amber-700">
                Verified Lab Credential
              </p>
            </div>

            <div className="text-center">
              <div className="h-8 border-b border-slate-300 w-28 sm:w-36 mx-auto mb-1" />
              <p className="text-[10px] font-bold text-slate-700 uppercase">Faculty Instructor</p>
