 ...
 * Faithful JavaScript implementation of EXP7/app.py logic:
...
export const EXPERIMENT_CONFIG = {
  ...
  courseCode: "CS-KGIRS-07",
  targetRolls: "Roll Numbers 31 – 35 (Division C)",
  objectives: [
 ...
 * Identical mapping table from EXP7 app.py
 */
