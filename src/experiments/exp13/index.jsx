...
export default function Experiment13({ onBack, onOpenProfile }) {
  ...
  return (
    <div className="flex-1 flex flex-col min-h-screen bg-slate-50">
      <ExperimentNavbar
        title="Exp 13: Advanced Cypher & Graph Pattern Matching"
        tabs={TABS}
        activeTab={activeTab}
        onTabChange={goTo}
        onBack={onBack}
      ...
      <footer className="bg-white border-t border-slate-200 py-4 text-center text-xs text-slate-500 no-print flex flex-col sm:flex-row items-center justify-center gap-2">
        <div>
          <span className="font-semibold text-slate-700">Advanced Cypher Queries &amp; Graph Pattern Matching</span>
          <span className="mx-2">·</span>
          <span className="font-mono">CS-KG-13 · Knowledge Graphs Track</span>
        </div>
