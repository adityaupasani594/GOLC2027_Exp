...
const EXP_META = {
  ...
  subtitle: 'Knowledge Graphs & Multi-Hop Traversal Laboratory',
  code: 'CS-KG-13',
  version: '1.0'
};
...
export default function CertificateSection({ quizScore = 10, totalQuestions = 10, studentInfo = {}, onInfoChange, onNext }) {
  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-8 space-y-6">
      ...
      >
        {/* Gradient header */}
        <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 px-8 py-8 text-white relative overflow-hidden">
          {/* Decorative circles */}
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="text-center py-2">
            ...
            <p className="text-sm font-semibold text-indigo-700 mt-0.5">Advanced Cypher Graph Traversals & Pattern Matching</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-400 text-center">
              {pct >= 70 ? '✓ Demonstrated proficiency in Cypher pattern matching and recursive graph query design.' : 'Review theory and simulations to reinforce graph traversal concepts.'}
            </p>
          </div>
          ...
          <div className="flex items-end justify-between pt-2">
            ...
            <div className="text-center">
              <div className="w-14 h-14 mx-auto bg-gradient-to-br from-indigo-600 to-violet-600 rounded-2xl flex items-center justify-center mb-1 shadow-lg shadow-indigo-200">
