# Experiment 9: Relationship Extraction from Text

## Overview
This directory contains the production React–Firebase implementation of **Experiment 9: Relationship Extraction from Text**, converted directly from the Python Streamlit codebase (`Experiments/EXP7/app.py` & `requirements.txt`).
...
| Feature in Streamlit (`app.py`) | React–Firebase Implementation (`src/experiments/exp9/`) |
| :--- | :--- |
