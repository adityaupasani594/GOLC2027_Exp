...
export default function StudentProfileModal({ isOpen, onClose, onLaunchExperiment }) {
  ...
  const printCertificate = (cert) => {
    ...
    printWindow.document.write(`
      ...
      <html>
        ...
        <body>
          <div class="cert-box">
            <div class="badge">KIRA Verified Academic Certificate</div>
            <h2>${cert.institution || user.institution || 'KIRA Lab'} • GOLC 2027</h2>
            ...
            <div class="footer">
              ...
              <div style="text-align: right;">
                <div style="font-weight: bold; font-size: 13px;">KIRA Evaluator</div>
                <div style="font-size: 11px; color: #64748b;">Knowledge Graph & Information Retrieval Analytics Lab</div>
              </div>
            </div>
          </div>
  ...
  const printReport = (report) => {
    ...
    printWindow.document.write(`
      ...
      <html>
        <head>
          <title>Laboratory Report - ${report.title}</title>
          <style>
        ...
        <body>
          <div class="header">
            <div>
              <div class="badge">KIRA Evaluation Report</div>
              <h1>${report.title}</h1>
              <div class="sub">${report.institution || user.institution || 'KIRA Lab'} • GOLC 2027</div>
            </div>
          ...
          <div class="footer">
            <div>Verified Academic Record • KIRA Lab • GOLC 2027</div>
            <div>Generated by KIRA Lab Platform</div>
          </div>
          <script>window.onload = () => { window.print(); };</script>
        </body>
      </html>
      ...
      >
              ...
              <div className="p-5 rounded-2xl bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div>
                  <div className="flex items-center gap-2 text-indigo-900 font-bold text-sm mb-0.5">
                    ...
                    <span>Evaluation of Retrieval Systems</span>
                  </div>
              ...
              {certList.length === 0 ? (
                <div className="p-8 text-center bg-white rounded-2xl border border-slate-200">
                  ...
                  <p className="text-xs text-slate-500 max-w-sm mx-auto mt-1 mb-4">
                    Complete the assessment quiz in any laboratory module to earn your first certified credential.
                  </p>
                  <button
                    onClick={() => {
                      onClose();
            ...
            >
              ...
              {reportList.length === 0 ? (
                <div className="p-8 text-center bg-white rounded-2xl border border-slate-200">
                  ...
                  <p className="text-xs text-slate-500 max-w-sm mx-auto mt-1 mb-4">
                    Execute the simulations in any laboratory module to automatically record your lab metrics and report.
                  </p>
                  <button
                    onClick={() => {
                      onClose();
        ...
        <div className="p-4 bg-white border-t border-slate-200/80 flex items-center justify-between text-xs text-slate-500">
          <div className="flex items-center gap-2">
            ...
            <span className="font-semibold text-slate-700">KIRA Lab Suite • GOLC 2027</span>
          </div>
