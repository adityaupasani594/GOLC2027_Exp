...
export default function UserDropdown({ onNavigateToLab }) {
  ...
  const completedCount = progress?.completedExperiments?.length || 1;
          ...
          >
            ...
            <div className="px-3 py-2.5 rounded-xl bg-slate-50 border border-slate-100 mb-2">
              ...
              <p className="text-[10px] text-indigo-600 font-medium mt-1 truncate">
                {user.institution || "VESIT - Computer Engineering"}
              </p>
            </div>
            ...
            {onNavigateToLab && (
              <button
                ...
                className="w-full flex items-center gap-2.5 px-3 py-2 rounded-xl text-xs font-medium text-slate-700 hover:bg-slate-100 hover:text-indigo-600 transition-colors cursor-pointer text-left"
              >
