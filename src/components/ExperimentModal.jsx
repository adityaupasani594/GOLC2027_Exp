            ...
            <div className="flex items-start justify-between gap-4">
              <div>
                <div className="flex items-center gap-2 mb-2 flex-wrap">
                  <span className="px-2.5 py-0.5 rounded-full text-xs font-bold tracking-wide uppercase bg-indigo-500/30 border border-indigo-400/30 text-indigo-200">
                    Experiment {experiment.number < 10 ? `0${experiment.number}` : experiment.number}
                  </span>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
              <div className="p-3.5 rounded-xl bg-slate-50 border border-slate-200/80 flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm font-bold text-slate-900">Lab {experiment.number} of 15</p>
                </div>
              </div>
