...
import { EXPERIMENT } from '../data/labData';
      ...
      >
        ...
        <div className="bg-gradient-to-r from-indigo-600 via-violet-600 to-purple-600 px-8 py-8 text-white relative overflow-hidden">
          ...
          <div className="relative flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              <h1 className="text-xl sm:text-2xl font-bold leading-tight mb-1">{EXPERIMENT.title}</h1>
              <p className="text-indigo-200 text-xs leading-relaxed">{EXPERIMENT.subtitle}</p>
            </div>
            {/* Grade badge */}
        ...
        <div className="px-8 py-6 space-y-6">
          ...
          <div className="text-center py-2">
            ...
            <p className="text-sm font-semibold text-indigo-700 mt-0.5">Information Retrieval Metrics Evaluation</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            <p className="text-xs text-slate-400 text-center">
              {pct >= 70 ? '✓ Demonstrated understanding of IR evaluation metrics.' : 'Continue practising to strengthen IR metric comprehension.'}
            </p>
          </div>
          ...
          <div className="flex items-center justify-between text-xs text-slate-400">
            <span className="font-mono bg-slate-50 border border-slate-200 px-2.5 py-1 rounded-lg">
              {EXPERIMENT.code} · v{EXPERIMENT.version}
            </span>
          </div>
